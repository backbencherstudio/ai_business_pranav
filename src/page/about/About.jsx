  ...
  return (
    <>
      <marquee className={"marquee"}>
        Progressive AI - AI Solutions - Businesses
      </marquee>
      ...
      <div class="chonro">
        <div data-aos="fade-up" class="StrategicSolutions left">
        ...
        <div data-aos="fade-up" class="StrategicSolutions right">
          <span>[ Security & Compliance ]</span>
          <p>AI governance that works to protect sensitive data.</p>
        </div>

        <div data-aos="fade-up" class="StrategicSolutions more-right">
